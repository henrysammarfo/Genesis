...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    ...
    {
      quote:
        "Genesis has revolutionized how we handle smart contracts. The automation saves us hours every week and eliminates errors completely.",
      name: "Sarah Chen",
    ...
    {
      quote:
        "The smart contract generation is a game-changer. What used to take our team days now happens automatically with perfect accuracy.",
