    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col">
      ...
      <PanelGroup direction="horizontal" className="flex-1">
        ...
        <Panel defaultSize={20} minSize={15} maxSize={30}>
          <div className="h-full border-r border-gray-800 bg-[#0f0f0f] flex flex-col">
            {/* Project Switcher */}
        ...
        <PanelResizeHandle className="w-1 bg-gray-800 hover:bg-purple-500 transition-colors" />

        {/* Middle Panel - Command Center (AI-1) */}
        <Panel defaultSize={45} minSize={30}>
          <div className="h-full border-r border-gray-800 bg-[#0a0a0a] flex flex-col">
            <div className="p-4 border-b border-gray-800">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
